...
[ExecutionManager component](https://kas.pr/je9d)
and
[Starting processes using the system program ExecutionManager](https://kas.pr/wek3)
...
The expected output can be found in the [./expected_output](expected_output) file.
