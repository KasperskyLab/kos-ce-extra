...
1. If not already installed, [build and install](https://github.com/KasperskyLab/cpython-kos)
...
>  [Python for KasperskyOS](https://github.com/KasperskyLab/cpython-kos).
